...
# A, paths
train = 'raw_data/train.csv'               # path to training file
test = 'raw_data/test.csv'                 # path to testing file
submission = 'submission/ftrl_submission.csv'  # path of to be outputted submission file
